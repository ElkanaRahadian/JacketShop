...
public class Main {
	...
	public static void main(String[] args) {
		...
		Vector<Integer> VecJacketPrice = new Vector<>();
			...
			case 1:
				if (VecJacketName.size() == 0) {
					...
					System.out.println(
							"---------------------------------------------------------------------------------------------");
					System.out.println(
							"|No. |Jacket Code |Jacket Name         |Category         |Release Date         |Price       |");
					System.out.println(
							"---------------------------------------------------------------------------------------------");
...
//					System.out.println("|2.  |JT152       |fire jacket         |Varsity          |12-11-2015           |Rp.10000    |");
			...
			case 2:
				...
				} while (!(CategoryJaket.equals("Bomber") || CategoryJaket.equals("Leather")
						|| CategoryJaket.equals("Varsity")));
				do {
